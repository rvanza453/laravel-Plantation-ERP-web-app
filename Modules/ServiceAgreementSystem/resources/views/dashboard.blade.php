<x-serviceagreementsystem::layouts.master :title="'Dashboard'">
    ...
    <div class="sas-dashboard">
        ...
        <div class="welcome-banner">
            ...
            @if(in_array(auth()->user()->role?->name, ['Staff', 'Admin']))
            <div class="welcome-action">
                <a href="{{ route('sas.uspk.create') }}" class="btn-white">
        ...
        <div class="premium-stats-grid">
            <div class="premium-stat-card card-total">
                ...
                <div class="premium-stat-info">
                    <span class="premium-stat-value">{{ $stats['total_uspk'] }}</span>
            ...
            <div class="premium-stat-card card-draft">
                ...
                <div class="premium-stat-info">
                    <span class="premium-stat-value">{{ $stats['draft'] }}</span>
            ...
            <div class="premium-stat-card card-submitted">
                ...
                <div class="premium-stat-info">
                    <span class="premium-stat-value">{{ $stats['submitted'] }}</span>
            ...
            <div class="premium-stat-card card-review">
                ...
                <div class="premium-stat-info">
                    <span class="premium-stat-value">{{ $stats['in_review'] }}</span>
            ...
            <div class="premium-stat-card card-approved">
                ...
                <div class="premium-stat-info">
                    <span class="premium-stat-value">{{ $stats['approved'] }}</span>
            ...
            <div class="premium-stat-card card-rejected">
                ...
                <div class="premium-stat-info">
                    <span class="premium-stat-value">{{ $stats['rejected'] }}</span>
        ...
        <div class="premium-card">
            <div class="premium-card-header">
                ...
                <a href="{{ route('sas.uspk.index') }}" class="btn btn-primary" style="border-radius: 10px;">
            ...
            <div class="premium-table-wrapper" style="overflow-x: auto;">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <a href="{{ route('sas.uspk.show', $uspk->id) }}" style="text-decoration: none;">
                            ...
                            <td style="font-weight: 500; color: #1e293b;">{{ $uspk->title }}</td>
                            <td>
                            ...
                            <td>
                                <span class="modern-badge mb-{{ strtolower($uspk->status) }}">
                                    {{ ucfirst(str_replace('_', ' ', $uspk->status)) }}
                                </span>
                            </td>
                            <td style="color: #64748b;">{{ $uspk->created_at->format('d M Y') }}</td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="6">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // 1. Chart: Department
            const deptData = @json($uspkByDepartment);
            ...
            // 2. Chart: Status
            const statusData = @json($mappedStatusData);
            ...
            const topCData = @json($topContractors);
            ...
            const lateCData = @json($lateContractors);
