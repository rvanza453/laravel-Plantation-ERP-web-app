            ...
            <div class="flex-1 space-y-8">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    <div class="rounded-[24px] bg-white p-6 shadow-[0_8px_20px_-6px_rgba(0,0,0,0.03)] border border-gray-50 flex flex-col justify-between">
                        ...
                        <div class="mt-4 flex items-end justify-between">
                            <p class="text-3xl font-black text-gray-900"><?php echo e(number_format($stats['sampling_batches'] ?? 0)); ?></p>
                    ...
                    <div class="rounded-[24px] bg-white p-6 shadow-[0_8px_20px_-6px_rgba(0,0,0,0.03)] border border-gray-50 flex flex-col justify-between">
                        ...
                        <div class="mt-4 flex items-end justify-between">
                            <p class="text-3xl font-black text-gray-900"><?php echo e(number_format($stats['pending_analyses'] ?? 0)); ?></p>
                    ...
                    <div class="rounded-[24px] bg-white p-6 shadow-[0_8px_20px_-6px_rgba(0,0,0,0.03)] border border-gray-50 flex flex-col justify-between">
                        ...
                        <div class="mt-4 flex items-end justify-between">
                            <p class="text-3xl font-black text-gray-900"><?php echo e(number_format($stats['published_reports'] ?? 0)); ?></p>
                    ...
                    <div class="rounded-[24px] bg-white p-6 shadow-[0_8px_20px_-6px_rgba(0,0,0,0.03)] border border-gray-50 flex flex-col justify-between">
                        ...
                        <div class="mt-4 flex items-end justify-between">
                            <p class="text-3xl font-black text-gray-900"><?php echo e(number_format($stats['measurement_points'] ?? 0)); ?></p>
                ...
                <div class="relative overflow-hidden rounded-[30px] bg-[#FCEB8C] p-8 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6 shadow-sm">
                    ...
                    <div class="relative z-10 w-full md:w-auto flex justify-end">
                        <a href="<?php echo e(route('lab.sampling.form')); ?>" class="inline-flex h-16 w-16 items-center justify-center rounded-full bg-white text-gray-900 shadow-md hover:scale-105 hover:shadow-lg transition-all duration-300">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div class="lg:col-span-3 rounded-[30px] bg-white p-8 shadow-[0_8px_20px_-6px_rgba(0,0,0,0.03)] border border-gray-50">
                        ...
                        <div class="space-y-4">
                            ...
                            <a href="<?php echo e(route('lab.sampling.form')); ?>" class="flex items-center justify-between p-3 rounded-2xl hover:bg-gray-50 transition cursor-pointer group w-full text-left">
                                <div class="flex items-center gap-4">
                            ...
                            <a href="<?php echo e(route('lab.report.quality-daily')); ?>" class="flex items-center justify-between p-3 rounded-2xl hover:bg-gray-50 transition cursor-pointer group w-full text-left">
                                <div class="flex items-center gap-4">
                            ...
                            <a href="<?php echo e(route('lab.sampling.verifier')); ?>" class="flex items-center justify-between p-3 rounded-2xl hover:bg-gray-50 transition cursor-pointer group w-full text-left">
                                <div class="flex items-center gap-4">
...
</html><?php /**PATH C:\laragon\www\plantation.oilpam.my.id\Modules/LabSystem\resources/views/index.blade.php ENDPATH**/ ?>