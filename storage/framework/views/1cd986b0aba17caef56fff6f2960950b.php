...
<?php $component = Modules\ServiceAgreementSystem\View\Components\Layouts\Master::resolve(['title' => 'Edit Skema Approval'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    <div class="d-flex justify-between align-center mb-4">
        <div>
            <h1 style="font-size: 24px; font-weight: 700; color: var(--text-primary);">Edit Skema: <?php echo e($approval_schema->name); ?></h1>
            <p class="text-muted" style="font-size: 14px;">Modifikasi alur persetujuan dan departemen terkait.</p>
        </div>
        <div class="d-flex gap-2">
            <a href="<?php echo e(route('sas.approval-schemas.index')); ?>" class="btn btn-secondary">Batal</a>
            <button type="submit" form="schemaForm" class="btn btn-primary">Simpan Perubahan</button>
        </div>
    </div>

    <form id="schemaForm" action="<?php echo e(route('sas.approval-schemas.update', $approval_schema)); ?>" method="POST">
        <?php echo csrf_field(); ?>
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" required value="<?php echo e(old('name', $approval_schema->name)); ?>">
                    </div>
                    <div class="form-group" style="display: flex; align-items: flex-end; padding-bottom: 4px;">
                        <label class="d-flex align-center gap-2" style="cursor: pointer;">
                            <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $approval_schema->is_active) ? 'checked' : ''); ?> style="width: 18px; height: 18px; cursor: pointer;">
                ...
                <div class="form-group mb-0">
                    ...
                    <textarea id="description" name="description" class="form-control" rows="3"><?php echo e(old('description', $approval_schema->description)); ?></textarea>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 16px;">
                    ...
                    <label class="d-flex align-center gap-2" style="padding: 10px; border: 1px solid var(--border-color); border-radius: 8px; cursor: pointer; transition: var(--transition);">
                        <input type="checkbox" name="departments[]" value="<?php echo e($dept->id); ?>" class="dept-checkbox" <?php echo e(is_array($selectedDepts) && in_array($dept->id, $selectedDepts) ? 'checked' : ''); ?> style="width: 16px; height: 16px;">
                        <span style="font-size: 13px; font-weight: 500; color: var(--text-secondary);"><?php echo e($dept->name); ?></span>
                    </label>
    ...
    <script id="user-options-template" type="text/template">
        ...
        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($user->id); ?>"><?php echo e($user->name); ?> (<?php echo e($user->position ?? 'Staff'); ?>)</option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </script>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const existingSteps = <?php echo json_encode(old('steps', $approval_schema->steps), 512) ?>;
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\plantation.oilpam.my.id\Modules/ServiceAgreementSystem\resources/views/approval-schema/edit.blade.php ENDPATH**/ ?>