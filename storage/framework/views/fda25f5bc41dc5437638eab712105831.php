...
<?php $component = Modules\ServiceAgreementSystem\View\Components\Layouts\Master::resolve(['title' => 'Tambah Skema Approval'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <form id="schemaForm" action="<?php echo e(route('sas.approval-schemas.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
            ...
            <div class="card-body">
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" required placeholder="Cth: Approval Regional Sumatera" value="<?php echo e(old('name')); ?>">
                    </div>
                ...
                <div class="form-group mb-0">
                    ...
                    <textarea id="description" name="description" class="form-control" rows="3" placeholder="Berikan penjelasan singkat tentang kegunaan skema ini"><?php echo e(old('description')); ?></textarea>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(200px, 1fr)); gap: 16px;">
                    ...
                    <label class="d-flex align-center gap-2" style="padding: 10px; border: 1px solid var(--border-color); border-radius: 8px; cursor: pointer; transition: var(--transition);">
                        <input type="checkbox" name="departments[]" value="<?php echo e($dept->id); ?>" class="dept-checkbox" <?php echo e(is_array(old('departments')) && in_array($dept->id, old('departments')) ? 'checked' : ''); ?> style="width: 16px; height: 16px;">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\plantation.oilpam.my.id\Modules/ServiceAgreementSystem\resources/views/approval-schema/create.blade.php ENDPATH**/ ?>