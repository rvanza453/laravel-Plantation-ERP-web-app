...
<?php $component->withAttributes([]); ?>
    ...
    <script>
        ...
        const apiSubDepartmentsUrlTemplate = <?php echo json_encode(route('sas.api.sub-departments', ['departmentId' => '__DEPARTMENT_ID__']), 512) ?>;
        const apiBlocksUrlTemplate = <?php echo json_encode(route('sas.api.blocks', ['subDepartmentId' => '__SUB_DEPARTMENT_ID__']), 512) ?>;
        const apiBudgetActivitiesBaseUrl = <?php echo json_encode(route('sas.api.budget-activities'), 15, 512) ?>;
