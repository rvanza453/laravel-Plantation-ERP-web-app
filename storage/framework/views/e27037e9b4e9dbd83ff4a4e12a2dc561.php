...
<?php $component = Modules\ServiceAgreementSystem\View\Components\Layouts\Master::resolve(['title' => 'Buat BAPP Baru'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        <a href="<?php echo e(route('sas.bapp.index')); ?>" class="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800 font-semibold mb-6 transition">
        ...
        <form action="<?php echo e(route('sas.bapp.store')); ?>" method="POST" class="wizard-card">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div>
                    ...
                    <input type="text" name="bapp_number" class="form-control" required placeholder="Contoh: BAPP-001/ENG/2026" value="<?php echo e(old('bapp_number')); ?>">
                </div>
                <div>
                    <label class="form-label">Tanggal BAPP</label>
                    <input type="date" name="bapp_date" class="form-control" required value="<?php echo e(old('bapp_date')); ?>">
                </div>
                <div class="md:col-span-2">
                    <label class="form-label">Link File Dokumen (G-Drive / OneDrive dsb)</label>
                    <input type="url" name="document_link" class="form-control" required placeholder="https://..." value="<?php echo e(old('document_link')); ?>">
                </div>
            </div>
                ...
                <div>
                    ...
                    <select name="job_id" id="job_select" class="form-control" required>
                        ...
                        <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($job->id); ?>" <?php echo e(old('job_id') == $job->id ? 'selected' : ''); ?>><?php echo e($job->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchUspk() {
                ...
                fetch(`<?php echo e(route('sas.api.eligible-uspks')); ?>?job_id=${jobId}`)
                    .then(res => res.json())
                    .then(data => {
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\plantation.oilpam.my.id\Modules/ServiceAgreementSystem\resources/views/bapp/create.blade.php ENDPATH**/ ?>