...
<?php $component->withAttributes([]); ?>
    <div class="max-w-2xl">
        ...
        <form method="POST" action="<?php echo e(route('admin.users.store')); ?>" class="bg-white rounded-lg shadow p-6 space-y-6">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\plantation.oilpam.my.id\resources\views\admin\users\create.blade.php ENDPATH**/ ?>