            ...
            <div class="uspk-card">
                <div class="uspk-card-header">
                    <a href="<?php echo e(route('sas.uspk.show', $uspk)); ?>" class="uspk-number">
                        <i class="fas fa-file-contract mr-1"></i> <?php echo e($uspk->uspk_number); ?>

                    </a>
                    <div class="uspk-date" title="Tanggal Approved">
                        <i class="fas fa-clock"></i> 
                        <?php echo e(optional($uspk->updated_at)->format('d M Y, H:i')); ?>

                    </div>
                </div>

                <div class="uspk-card-body">
                    <h3 class="uspk-title"><?php echo e(Str::limit($uspk->title, 55)); ?></h3>
                    
                    <div class="info-grid">
                        <div class="info-item">
                            <span class="info-label">Department</span>
                            <span class="info-value">
                                <i class="fas fa-building text-muted mr-1"></i> <?php echo e($uspk->department->name ?? '-'); ?>
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value">
                                <i class="fas fa-user text-muted mr-1"></i> <?php echo e($uspk->submitter->name ?? '-'); ?>
                ...
                <div class="uspk-card-footer">
                    <a href="<?php echo e(route('sas.uspk.show', $uspk)); ?>" class="btn btn-outline-secondary btn-sm" style="border-radius: 6px;">
                        <i class="fas fa-eye"></i> Detail
                    </a>
                    <a href="<?php echo e(route('sas.uspk-legal.export', $uspk)); ?>" class="btn btn-primary btn-sm" style="border-radius: 6px; box-shadow: 0 2px 4px rgba(59, 130, 246, 0.3);">
...
<?php endif; ?><?php /**PATH C:\laragon\www\plantation.oilpam.my.id\Modules/ServiceAgreementSystem\resources/views/uspk-legal/index.blade.php ENDPATH**/ ?>