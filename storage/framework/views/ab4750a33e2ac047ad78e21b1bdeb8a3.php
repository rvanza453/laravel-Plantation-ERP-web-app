...
<head>
    ...
    <title><?php echo e($title ?? 'HR Dashboard'); ?> - HR & ISPO System</title>
    ...
    <aside class="hr-sidebar" id="mainSidebar">
        ...
        <nav class="nav-content">
            <div class="nav-section">
                ...
                <a href="<?php echo e(route('hr.dashboard')); ?>" class="nav-item <?php echo e(request()->routeIs('hr.dashboard') ? 'active' : ''); ?>">
            ...
            <div class="nav-section">
                ...
                <a href="<?php echo e(route('hr.external-requests.index')); ?>" class="nav-item <?php echo e(request()->routeIs('hr.external-requests.*') ? 'active' : ''); ?>">
            ...
            <div class="nav-section">
                ...
                <a href="<?php echo e(route('ispo.index')); ?>" class="nav-item <?php echo e(request()->routeIs('ispo.*') ? 'active' : ''); ?>">
        ...
        <div class="sidebar-user">
            <div class="user-pill">
                ...
                <div style="flex: 1; overflow: hidden;">
                    <div style="font-size: 13px; font-weight: 800; color: #f8fafc; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><?php echo e(auth()->user()->name); ?></div>
        ...
        <header class="hr-header">
            <div class="flex items-center gap-6">
                ...
                <div class="hr-breadcrumb hidden md:flex">
                    <a href="<?php echo e(route('modules.index')); ?>"><i class="fas fa-home opacity-70"></i></a>
                    <span class="separator"><i class="fas fa-chevron-right"></i></span>
                    <a href="<?php echo e(route('hr.dashboard')); ?>">HR Unit</a>
                    <span class="separator"><i class="fas fa-chevron-right"></i></span>
                    <span class="current"><?php echo e($title ?? 'Dashboard'); ?></span>
                </div>
            </div>
            ...
            <div class="header-actions">
                ...
                <a href="<?php echo e(route('modules.index')); ?>" class="module-switcher">
...
</html><?php /**PATH C:\laragon\www\plantation.oilpam.my.id\Modules/SystemISPO\resources/views/components/layouts/hr-master.blade.php ENDPATH**/ ?>