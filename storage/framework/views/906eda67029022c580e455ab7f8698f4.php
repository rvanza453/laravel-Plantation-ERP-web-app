...
<?php $component->withAttributes([]); ?>
    <div class="max-w-2xl">
        ...
        <form method="POST" action="<?php echo e(route('admin.users.update', $user)); ?>" class="bg-white rounded-lg shadow p-6 space-y-6">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\plantation.oilpam.my.id\resources\views\admin\users\edit.blade.php ENDPATH**/ ?>