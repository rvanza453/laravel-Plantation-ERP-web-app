        ...
        <div class="pf-card-dark">
            <div class="header-flex">
                <div>
                    ...
                    <div class="text-muted">Halo, <?php echo e(explode(' ', auth()->user()->name)[0]); ?></div>
                </div>
            ...
            <div>
                ...
                <div class="balance-value"><?php echo e($stats['total'] ?? 0); ?> <span style="font-size: 18px; color: #a1a1aa; font-weight: 500;">Data</span></div>
            </div>
        </div>
    ...
    <div class="pf-grid-modules">
        ...
        <div class="pf-card-light">
            ...
            <div class="pf-btn-group">
                <a href="<?php echo e(route('hr.external-requests.index')); ?>" class="pf-btn pf-btn-dark">
                    Kelola Data
                </a>
            </div>
        </div>
        ...
        <div class="pf-card-light">
            ...
            <div class="pf-btn-group">
                <a href="<?php echo e(route('ispo.index')); ?>" class="pf-btn pf-btn-light">
                    Lihat Audit
                </a>
            </div>
        </div>
    ...
    <div class="pf-card-light">
        ...
        <div class="pf-table-wrapper">
            <table class="pf-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $recentRequests ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <div style="display: flex; align-items: center;">
                                    <div class="pf-avatar"><?php echo e(strtoupper(substr(str_replace('_', ' ', $ticket->pihak_peminta), 0, 1))); ?></div>
                                    <div>
                                        <div style="color: #111;"><?php echo e(ucwords(str_replace('_', ' ', $ticket->pihak_peminta))); ?></div>
                                        <div class="text-muted" style="font-size: 12px;">#<?php echo e($ticket->nomor_referensi); ?></div>
                                    </div>
                                </div>
                            </td>
                            <td style="color: #4b5563;"><?php echo e(ucwords(str_replace('_', ' ', $ticket->kategori_data))); ?></td>
                            <td class="text-muted"><?php echo e(optional($ticket->tanggal_surat_masuk)->format('d M Y, H:i') ?: '-'); ?></td>
                            <td>
                                <?php
                                ...
                                ?>
                                <span class="pf-status-pill <?php echo e($dotClass); ?>"><?php echo e($ticket->status_proses); ?></span>
                            </td>
                            <td style="text-align: right;">
                                <a href="<?php echo e(route('hr.external-requests.show', $ticket)); ?>" class="text-muted" style="text-decoration: none; padding: 8px;">
        ...
        <div style="text-align: center; margin-top: 24px;">
            <a href="<?php echo e(route('hr.external-requests.index')); ?>" class="pf-btn pf-btn-light" style="padding: 10px 24px;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\plantation.oilpam.my.id\Modules/SystemISPO\resources/views/hr/dashboard.blade.php ENDPATH**/ ?>